...
class ConnexionBD {
    ...
    public static function getInstance(): PDO {
        ...
        if (self::$instance === null) {
            ...
            self::$instance->exec("SET character_set_inscription = 'utf8'");
            self::$instance->exec("SET character_set_organisateur = 'utf8'");
            self::$instance->exec("SET character_set_commentaire = 'utf8'");
            self::$instance->exec("SET character_set_message = 'utf8'");
            self::$instance->exec("SET character_set_evenement = 'utf8'");
            self::$instance->exec("SET character_set_statistique = 'utf8'");
        }
