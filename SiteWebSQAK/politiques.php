...
<body class="Politiques">
    <div>
        ...
        <p class="txt-politique">Les événements à but lucratif, commerciaux, ou visant à promouvoir des produits ou services 
           pour un profit personnel ou d'entreprise ne sont pas autorisés.</p>

        <h3>Responsabilités des utilisateurs</h3>
        <p class="txt-politique">Les utilisateurs sont responsables de la validité et de l'éthique des événements qu'ils publient.
        ...
        <p class="txt-politique">La confidentialité de vos données est une priorité pour nous. Cette politique vise à vous informer sur
           ...
           Nous collectons certaines informations (nom, e-mail, données de navigation) pour améliorer nos services, traiter vos demandes et garantir la sécurité de notre site.
           Vos données ne sont ni vendues ni louées, mais peuvent être partagées avec des prestataires de confiance pour assurer le bon fonctionnement de nos services. 
           Vous pouvez gérer vos préférences via les paramètres de votre navigateur et exercer vos droits (accès, modification, suppression) en nous contactant.
        </p>
