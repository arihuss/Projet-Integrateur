...
<?php endif; ?>
    ...
    <div id="form-section">
        <div class="form-column">
            ...
            <input id="prenom-ins" type="text" name="prenom" value="<?= htmlspecialchars($_POST['prenom'] ?? '') ?>"> 
            <br>
            <label for="nom-ins">Nom:</label>
            <input id="nom-ins" type="text" name="nom" value="<?= htmlspecialchars($_POST['nom'] ?? '') ?>"> 
        </div>
        ...
        <div class="form-column">
            ...
            <input id="organisation-ins" type="text" name="organisation" value="<?= htmlspecialchars($_POST['organisation'] ?? '') ?>"> 
        </div>
    </div>

    <div id="form-bottom">
        <label for="courriel-ins">Courriel:</label>
        <input id="courriel-ins" type="email" name="courriel" value="<?= htmlspecialchars($_POST['courriel'] ?? '') ?>" required> 
        <br>
        <label for="tel-ins">Numéro de téléphone:</label>
        <input id="tel-ins" type="tel" name="telephone" value="<?= htmlspecialchars($_POST['telephone'] ?? '') ?>" placeholder="514-222-2222" pattern="^\d{3}-\d{3}-\d{4}$"> 
        <br>
